  ...
  return (
    <Box sx={{ padding: 2, border: 'none' }}>
      ...
      <Box className={styles.cardContainer}>
        {[
          { id: 'card1', src: lawyers1, description: "С более чем десятилетним опытом в области банкротства, я ,как юрист, гарантирую профессиональный подход к каждому делу. Я уверенно веду клиентов через сложные процессы, защищая их интересы и обеспечивая максимальную выгоду. Ваши проблемы — мое дело! ", alt: "first image", slogan: 'Более 10 лет опыта ведения банкротных дел' },
          { id: 'card2', src: lawyers2, description: "Как ваш юрист, я ценю уникальность каждой ситуации. Индивидуальный подход к каждому клиенту позволяет мне глубже понять ваши потребности, обеспечить качественную защиту ваших интересов и предложить решения, которые действительно работают именно для вас. ", alt: "second image", slogan: 'Индивидуальный подход к каждому' },
          { id: 'card3', src: lawyers3, description: "Выбирая меня в качестве вашего юриста, вы получаете уверенность в успехе. Я ставлю перед собой четкие цели и тщательно разрабатываю стратегию, чтобы гарантировать результат. Ваши интересы — моя приоритетная задача, и я делаю все возможное, чтобы оправдать ваше доверие.", alt: "third image", slogan: 'Гарантия результата каждому клиенту' },
